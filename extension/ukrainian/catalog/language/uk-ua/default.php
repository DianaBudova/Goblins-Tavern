...
$_['error_upload_6'] = 'Попередження: Відсутня тимчасова директорія!';
...
$_['error_upload_size'] = 'Увага: Завантажений файл перевищує максимальний розмір файлу. Максимальний розмір %s МБ!';
$_['error_curl'] = 'CURL: Помилка коду (%s): %s';
$_['error_session'] = 'Увага: Сеанс закінчився, будь ласка, надішліть форму ще раз!';
