...
$_['text_description'] = 'Будь ласка, заповніть форму запиту на повернення товару.</p>';
$_['text_order'] = 'Інформація про замовлення';
$_['text_product'] = 'Інформація про товар';
$_['text_reason'] = 'Інформація про причину повернення';
$_['text_message'] = '<p>Ви надіслали запит на повернення.</p><p> Повідомлення про статус запиту ви отримаєте на ваш e-mail. Дякую!</p>';
...
$_['text_no_results'] = 'У Вас не було раніше повернення товарів!';
$_['text_agree'] = 'Я прочитав <a href="%s" class="modal-link"><b>%s</b></a> та погоджується з умовами';
...
$_['error_token'] = 'Попередження: Неприпустимий токен скидання!';
...
$_['error_product'] = 'Найменування товару має бути від 3 до 255 символів!';
$_['error_model'] = 'Назва моделі повинна бути від 3 до 64 символів!';
